...
export default function Contact(){
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_la0uqug', 'template_4ltmkkl', form.current, 'k9b9cywh57jBsPvp-')
       e.target.reset()
    };
    return(
            ...
            <div className="contact__content">
                ...
                <form  ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div">
                        ...
                        <input type="text"  name='name' placeholder='insert your email' className='contact__form-input'/>
                    </div>

                    <div className="contact__form-div contact__form-area">
                        <label className="contact__form-tag">Project</label>
                        <textarea name="project" className="contact__form-input" placeholder="write your project" rows="10" cols="30"></textarea>
                    </div>
